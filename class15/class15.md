...
Add annotation (i.e. different gene names and ids) &gt;Use the mapIDs() function multiple times to add SYMBOL, ENTREZID and GENENAME annotation to our results by completing the code below.
...
```
    ...
    ## Info: Working in directory /Users/enriquesandoval/Desktop/bimm143_github/class15
